...
public:
	...
	*/
	...
	/**
	* Test Function override the music timer
	*
	*/
	UFUNCTION(BlueprintCallable, meta = (DisplayName = "Resume Calculate Freq Spectrum At Specific Time"), Category = "SoundVis | Frequency Spectrum")
		void BP_ResumeCalculatingFrequencySpectrumAtSpecificTime(float Time);
