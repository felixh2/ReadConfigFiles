...
#pragma optimize("", off)
AEnhancedPlayerContoller::AEnhancedPlayerContoller() 
{
	

}

void AEnhancedPlayerContoller::BeginPlay()
{
	Super::BeginPlay();
...
TMap<int32, FChoicesPerRow> AEnhancedPlayerContoller::ReadFromConfigFile()
{

	if (!GConfig) return TMap<int32, FChoicesPerRow>();
	...
	if (!EnumPtr) return TMap<int32, FChoicesPerRow>();
...
void AEnhancedPlayerContoller::ParseQueryString(FString QueryString)
{
	int32 ArrayIndex = 1;
	...
	FChoicesPerRow ChoicesPerRowStruct;
...
TMap<int32, FChoicesPerRow> AEnhancedPlayerContoller::GetChoicesPerLevel()
{
	return ChoicesPerLevel;
}
